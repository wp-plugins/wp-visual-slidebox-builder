...
<div class="row">
    ...
    <a class='span3 pull-right feedback' target='blank' href="http://wpvisualslideboxbuilder.com/forums/"><img
            style='margin-top: -10px;' width='25'
            src='<?php echo plugins_url() ?>/wp-visual-slidebox-builder/img/thumsup.svg'/> We love your feedback </a>
    <a style='margin-top: -5px;' class='span3 pull-right feedback' target='blank'
       href="http://wordpress.org/support/view/plugin-reviews/wp-visual-slidebox-builder">***** Rate me!</a>
</div>
<div id="fb-root"></div>
    ...
    <div class="menu-main span12 pull-right">
        ...
        <div class="save_box">
            ...
            <div class="lins_menu_wrapper span6">
                <a target='blank' href='http://wpvisualslideboxbuilder.com/forums/'
                   class="links_menu label label-inverse label-normal" href="">
                    <?php _e('Support', 'wp-visual-slidebox-builder'); ?>
                </a>
                <a target='blank' href="http://www.wpvisualslideboxbuilder.com/donate"
                   class="links_menu label label-inverse label-normal" href="">
                ...
                <a class="webAddress" target="blank"
                   href="http://www.wpvisualslideboxbuilder.com"><?php _e('www.wpvisualslideboxbuilder.com', 'wp-visual-slidebox-builder'); ?></a>
            </div>
            <div style="clear: both;"></div>
            <div class="row">
                <div class="resp-menu">
                    <div style="clear: both;"></div>
                    <a target="_blank" href="http://wpvisualslideboxbuilder.com/responsive-pack-2/">Responsive Pack Available Now!</a>
                    <div style="clear: both;"></div>
                    <span class="label 2 muted">Make your slide boxes responsive using the new responsive pack. </span>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="row-fluid">
        ...
        <div class="span6" style='margin: 0'>
            <div class="section span12 bColor">
                <span class="label2 span12 muted"><?php _e('Background', 'wp-visual-slidebox-builder'); ?> <a
                        class="transparent transparentContainer label "><?php _e('TRANSPARENT', 'wp-visual-slidebox-builder'); ?></a></span>
                <input class="span3 colorInput save_BackgroundColor_1" value="#B9B9B9" placeholder="ex. #fff"
                       type="color">
            ...
            <div class="section span12 fontColor">
                <span class="label2 span12 muted"><?php _e('Font', 'wp-visual-slidebox-builder'); ?>  <a
            ...
            <div class="section span12 fontColor">
                <label for="upload_image" style="margin-top: 20px;">
                    ...
                    <input id="upload_image_button" class="btn" type="button" value="Background Image"
        ...
        <div class="span4" style="margin-left: 0">
            <div class="section">
                ...
                <div class="span6" style="margin-left: -6px;">
                    <span class="label2 span12 muted"
    ...
    <div class="span6 bottom_side" style="margin-left: 0">
        <div class="span12 section">
            <div class="span12 bColorLit">
                ...
                <input class="span3 colorInput save_BackgroundColor_1 lit_prop" value="#000" placeholder="ex. #fff"
                       type="color">
                <button class="setBtn btn btn- btn-mini"><?php _e('SET', 'wp-visual-slidebox-builder'); ?></button>
                <button
                    class="resetBtn btn btn-danger btn-mini"><?php _e('Reset', 'wp-visual-slidebox-builder'); ?></button>
            ...
            <div class="span12 litTitleColor">
                <span class="label2 span12 muted"><?php _e('Title', 'wp-visual-slidebox-builder'); ?>  <a
            ...
            <div class="span12">
                <label for="upload_image2">
                    ...
                    <input style="width: 133px;font-size: 12px;min-height: 36px;" id="upload_image_button2" class="btn"
            ...
            <div class="span12 section titleFont" style="margin-top: 10px">
                <span class="label2 span12 muted"
                      style="margin-top: 6px;margin-bottom: -6px;margin-left: 11px!important;"><?php _e('Title Font Size', 'wp-visual-slidebox-builder'); ?></span>
    ...
    <div class="row-fluid">
        <div class="span6" style='margin: 0; margin-left: 10px;'>
            <div class="span12 effectLit animated">
                ...
                <span
                    class="label2 span12 muted"><?php _e('Only Valid for slide effect', 'wp-visual-slidebox-builder'); ?></span>

                <div class="entranceOpts"><input class="entranceOpt" type="radio" name="entrance" checked value="1">
                    <span class="label transparent"><?php _e('Bottom', 'wp-visual-slidebox-builder'); ?></span></div>
                <div class="entranceOpts"><input class="entranceOpt" type="radio" name="entrance" value="2"> <span
                        class="label transparent"><?php _e('Top', 'wp-visual-slidebox-builder'); ?></span></div>
                <br>

                <div class="entranceOpts"><input class="entranceOpt" type="radio" name="entrance" value="3"> <span
                        class="label transparent"><?php _e('Left', 'wp-visual-slidebox-builder'); ?></span></div>
                <div class="entranceOpts"><input class="entranceOpt" type="radio" name="entrance" value="4"> <span
            ...
            <div class="section span6 opacityLit" style="margin-left: 0">
                <span class="label2 span12 muted"
                      style="margin-bottom: 4px;"><?php _e('Opacity', 'wp-visual-slidebox-builder'); ?></span>
