...
<div class="use-bootstrap-here">
    <div class="mainWrapper">
        <div class="row">
            ...
            <a class='span3 pull-right feedback' target='blank' href="http://wpvisualslideboxbuilder.com.com/contact/"><img style='margin-top: -10px;' width='25' src='<?php echo plugins_url() ?>/funbox/img/thumsup.svg'/> We love your feedback </a>
        </div>
        <div id="fb-root"></div>
        ...
        <div class="container-fluid subWrapper">
            <div class="row-fluid main_container">
                ...
                <div class="span6 sidebar" style="margin-left: 0">
                    <div class = "innerProp">
                        <div class="top">
